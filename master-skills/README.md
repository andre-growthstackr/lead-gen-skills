...
Just nu finns alla 28 Skills i `../skills/` som standalone Skills. När någon växer ut till en orchestrator (ColdIQ-stil med routing table + sub-skills) flyttas den hit.
